export const MESSAGES = {
  en: {
    'app.title': 'Global Situation Room',
    ...
    'news.hotspots': 'Hotspots',
    'news.clearHotspot': 'Clear hotspot',
    'news.noHotspots': 'No hotspots yet.',
    ...
    'details.locationReliability': 'Location',
    'details.locationReliability.verified': 'Verified',
    'details.locationReliability.llm_inferred': 'LLM inferred',
    'details.locationReliability.capital_fallback': 'Capital fallback',
    ...
    'scope.europe': 'Europe',
    'scope.africa': 'Africa',
    'scope.middle_east': 'Middle East',
    'scope.asia_pacific': 'Asia-Pacific',
  ...
  zh: {
    ...
    'news.category': '分类',
    'news.hotspots': '热点',
    'news.clearHotspot': '清除热点',
    'news.noHotspots': '暂无热点。',
    ...
    'details.locationReliability': '位置来源',
    'details.locationReliability.verified': '已验证',
    'details.locationReliability.llm_inferred': 'LLM 推测',
    'details.locationReliability.capital_fallback': '首都兜底',
    'details.mentions': '提及地点',
    ...
    'scope.europe': '欧洲',
    'scope.africa': '非洲',
    'scope.middle_east': '中东',
    'scope.asia_pacific': '亚太',

    'category.all': '全部',
    'category.conflict': '冲突',
    'category.politics': '政治',
    'category.economy': '经济',
    'category.disaster': '灾害',
    'category.health': '健康',
    'category.tech': '科技',
    'category.science': '科学',
    'category.energy': '能源',
